...
class Trainer:
    ...
    def train_epoch(self, X, y, batch_size, m):
        ...
        for i in range(0, m, batch_size):
            ...
            y_new = self.model.feedforward(X_batch)

            _, err = crossentropy_loss(y_new,y_batch)
    ...
    def train(self, X_train, y_train, X_val = None, y_val = None, epochs=50, batch_size=32):
        ...
        for epoch in range(epochs):
            ...
            train_loss, _ = crossentropy_loss(y_train, y_pred_train)
            ...
            if X_val is not None and y_val is not None:
                ...
                val_loss, _ = crossentropy_loss(y_val, y_pred_val)
